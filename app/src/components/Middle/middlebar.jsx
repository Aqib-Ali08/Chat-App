...
console.log("tools")
  return (
    <div className="mainmid">
      ...
      <form className="msg-form" action="post" id="form" onSubmit={handleSubmit}>
        <div className="msg-box">
          <input id="input" type="text" placeholder="Type a message here..." value={inputValue} onChange={handleChange}>
          </input>
        </div>
